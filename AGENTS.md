...
- external profile revision `2026-07-22`, SHA-256 `6200e96737a85d89a3d5af8e591c4c72af4beaa475c97edf7971f85a87814ec5`, fingerprint `fnv1a64:0bf533d9339eb246`, for build `16.14.794.5912` validates 684/684 kills, 99/99 objectives, 1,477/1,477 ward placements, 484/484 ward removals, 1,300/1,300 final player-stat values, 193/193 purchase-linked resulting-item updates, 1,278/1,278 direct add-only item purchases, 116/116 item-sale operations, and the profile-backed keyframe total-gold/lane-CS snapshot surface across the ten saved replay/API fixtures; ward position has zero valid candidates and remains unavailable
