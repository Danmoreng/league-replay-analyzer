...
[[nodiscard]] std::string extract_replay_direct_item_purchases_json(
    const std::vector<std::uint8_t>& bytes,
    const DecoderProfileRegistry& decoder_profiles
);
[[nodiscard]] std::string extract_replay_direct_item_purchases_file_json(
    const std::string& path,
    const DecoderProfileRegistry& decoder_profiles
);
[[nodiscard]] std::string extract_replay_item_sales_json(
    const std::vector<std::uint8_t>& bytes,
    const DecoderProfileRegistry& decoder_profiles
);
[[nodiscard]] std::string extract_replay_item_sales_file_json(
    const std::string& path,
    const DecoderProfileRegistry& decoder_profiles
);
