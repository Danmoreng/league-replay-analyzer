...
[[nodiscard]] std::string analyze_row_offsets_json(const std::vector<std::uint8_t>& bytes, std::size_t target_length, std::uint8_t target_first_byte, std::size_t header_size, std::size_t stride, const std::vector<std::size_t>& slot_indices, std::size_t top_fields);
[[nodiscard]] std::string analyze_row_offsets_file_json(const std::string& path, std::size_t target_length, std::uint8_t target_first_byte, std::size_t header_size, std::size_t stride, const std::vector<std::size_t>& slot_indices, std::size_t top_fields);
[[nodiscard]] std::string analyze_clean_row_offsets_json(const std::vector<std::uint8_t>& bytes, std::size_t target_length, std::uint8_t target_first_byte, std::size_t header_size, std::size_t stride, const std::vector<std::size_t>& slot_indices, std::size_t top_fields);
[[nodiscard]] std::string analyze_clean_row_offsets_file_json(const std::string& path, std::size_t target_length, std::uint8_t target_first_byte, std::size_t header_size, std::size_t stride, const std::vector<std::size_t>& slot_indices, std::size_t top_fields);
[[nodiscard]] std::string analyze_handle_links_json(const std::vector<std::uint8_t>& bytes, std::size_t target_length, std::uint8_t target_first_byte, std::size_t header_size, std::size_t stride, const std::vector<std::size_t>& slot_indices, std::size_t top_links, std::size_t top_families);
[[nodiscard]] std::string analyze_handle_links_file_json(const std::string& path, std::size_t target_length, std::uint8_t target_first_byte, std::size_t header_size, std::size_t stride, const std::vector<std::size_t>& slot_indices, std::size_t top_links, std::size_t top_families);
[[nodiscard]] std::string analyze_token_bitfields_json(const std::vector<std::uint8_t>& bytes, std::size_t target_length, std::uint8_t target_first_byte, std::size_t header_size, std::size_t stride, const std::vector<std::size_t>& slot_indices, std::size_t top_slices, std::size_t top_families);
[[nodiscard]] std::string analyze_token_bitfields_file_json(const std::string& path, std::size_t target_length, std::uint8_t target_first_byte, std::size_t header_size, std::size_t stride, const std::vector<std::size_t>& slot_indices, std::size_t top_slices, std::size_t top_families);
[[nodiscard]] std::string analyze_table_descriptors_json(const std::vector<std::uint8_t>& bytes, std::size_t target_length, std::uint8_t target_first_byte, std::size_t header_size, std::size_t stride, const std::vector<std::size_t>& slot_indices, std::size_t top_matches);
[[nodiscard]] std::string analyze_table_descriptors_file_json(const std::string& path, std::size_t target_length, std::uint8_t target_first_byte, std::size_t header_size, std::size_t stride, const std::vector<std::size_t>& slot_indices, std::size_t top_matches);
[[nodiscard]] std::string analyze_bitfield_schema_json(const std::vector<std::uint8_t>& bytes, std::size_t target_length, std::uint8_t target_first_byte, std::size_t header_size, std::size_t stride, const std::vector<std::size_t>& slot_indices, std::size_t top_windows);
[[nodiscard]] std::string analyze_bitfield_schema_file_json(const std::string& path, std::size_t target_length, std::uint8_t target_first_byte, std::size_t header_size, std::size_t stride, const std::vector<std::size_t>& slot_indices, std::size_t top_windows);
[[nodiscard]] std::string analyze_artifact_bundle_file_json(const std::string& path, std::size_t minimum_length, std::size_t minimum_records, std::size_t top_families, std::size_t top_entity_slots, std::size_t top_scalar_slots, std::size_t dynamic_slot_count, std::size_t mixed_slot_count, std::size_t handle_slot_count, std::size_t top_windows, std::size_t top_fields, bool skip_scalar);
