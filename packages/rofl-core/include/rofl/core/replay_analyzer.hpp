...
[[nodiscard]] std::string scan_keyframe_handle_graph_json(const std::string& path, std::size_t minimum_length = 4096, std::size_t top_families = 32, std::size_t max_records_per_family = 0);
